...
<head>
    ...
    <meta name="description" content="Tantang pengetahuan Anda dengan Tebak Gambar Game. Jawab pertanyaan dan tingkatkan skor Anda!">
    <meta name="author" content="Henhen">
    <meta property="og:title" content="Tebak Gambar Game" />
    <meta property="og:description" content="Tantang pengetahuan Anda dengan Tebak Gambar Game." />
    <meta property="og:image" content="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQklLK0eu0HjqRmy18ail_iev3NAyi2lTjAHQ&s" /> <!-- Ganti dengan URL thumbnail yang sesuai -->
    <meta property="og:url" content="https://henxyzz.github.io/Game/tggame.html" />
    <title>Tebak Gambar Game</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<h1>Tebak Gambar Game</h1>
<div id="container">
    <div id="score">Skor: 0</div>
    <div id="question"></div>
    <img id="image" src="" alt="Gambar" style="max-width: 100%; height: auto; border-radius: 10px;"/>
    <div id="input-container"></div> <!-- Kontainer untuk kotak input -->
    <button id="submit-button">Kirim Jawaban</button>
    <div id="response"></div>

    <div class="share-icons">
        <a href="https://wa.me/?text=Saya%20sedang%20bermain%20Tebak%20Gambar%20Game!%20Coba%20lihat%20di%20https://henxyzz.github.io/Game/tggame.html" target="_blank">
            <img src="https://img.icons8.com/ios-filled/50/ffffff/whatsapp.png" class="share-icon" alt="Share on WhatsApp">
        </a>
        <a href="https://www.facebook.com/sharer/sharer.php?u=https://henxyzz.github.io/Game/tggame.html" target="_blank">
            <img src="https://img.icons8.com/ios-filled/50/ffffff/facebook-new.png" class="share-icon" alt="Share on Facebook">
        </a>
        <a href="https://www.instagram.com/?url=https://henxyzz.github.io/Game/tggame.html" target="_blank">
...
<footer>
    &copy; 2024 Tebak Gambar Game by Henhen
</footer>

<script>
    let score = 0; // Skor pengguna
    const answers = []; // Menyimpan jawaban yang benar
    const hints = 3; // Jumlah hint

    // Mengambil data dari API
    async function fetchQuestion() {
        const apiKey = "FuadXyro"; // Ganti dengan API Key yang sesuai
        const response = await fetch(`https://api-zenith.koyeb.app/api/game/tebakgambar?apikey=${apiKey}`);
    ...
    function displayQuestion(questionData) {
        document.getElementById("question").innerText = questionData.deskripsi;
        document.getElementById("image").src = questionData.img; // Menampilkan gambar
        answers.length = 0; // Reset answers
        answers.push(questionData.jawaban.toLowerCase()); // Menyimpan jawaban yang benar
